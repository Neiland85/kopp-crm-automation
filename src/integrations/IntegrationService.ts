...
export class IntegrationService {
  ...
  setupWebhookRoutes(app: express.Application): void {
    ...
    app.post('/webhooks/zapier', async (req: Request, res: Response): Promise<void> => {
      try {
    ...
    app.post('/webhooks/slack', async (req: Request, res: Response): Promise<void> => {
      try {
    ...
    app.post('/webhooks/hubspot', async (req: Request, res: Response): Promise<void> => {
      try {
