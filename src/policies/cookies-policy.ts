...
export class CookiesPolicyManager {
  ...
  static readonly COOKIE_CATEGORIES: CookieCategory[] = [
    {
      ...
      description:
        'Cookies técnicamente necesarias para el funcionamiento básico del sitio web. No requieren consentimiento según el artículo 22.2 de la LSSI.',
      essential: true,
      enabled: true,
      purpose:
        'Garantizar la funcionalidad básica, seguridad y navegación del sitio web',
      legalBasis:
        'Interés legítimo (Art. 6.1.f RGPD) - Funcionalidad esencial del servicio',
      dataTransfer:
        'Datos procesados en servidores UE (certificación adequacy)',
      retention: '1 año máximo, generalmente sesión o 30 días',
      processors: [
        'Kopp Stadium S.L.',
        'Proveedor de hosting certificado ISO 27001',
      ],
      cookies: [
        {
          name: 'session_id',
    ...
    },
    {
      ...
      description:
        'Cookies que recopilan información sobre el uso del sitio web para mejorar el rendimiento y la experiencia del usuario. Procesamiento pseudoanonimizado.',
      essential: false,
      enabled: false,
      purpose:
        'Análisis de comportamiento de usuarios, métricas de rendimiento y optimización de experiencia',
      legalBasis:
        'Consentimiento (Art. 6.1.a RGPD) - Previa información y consentimiento específico',
      dataTransfer:
        'Datos transferidos a Google LLC (EE.UU.) bajo adequacy decision',
      retention:
        '26 meses (Google Analytics 4) - Configuración personalizada: 14 meses',
      ...
      cookies: [
        ...
        },
        {
          ...
          domain: '.kopp-stadium.com',
          purpose:
            'Métricas internas de rendimiento y uso (datos pseudoanonimizados)',
          duration: '12 meses',
          type: 'persistent',
          secure: true,
          httpOnly: true,
    ...
    },
    {
      ...
      description:
        'Cookies utilizadas para mostrar publicidad relevante y medir la efectividad de campañas publicitarias. Incluyen remarketing y segmentación.',
      essential: false,
      enabled: false,
      purpose:
        'Publicidad dirigida, remarketing, medición de campañas y segmentación de audiencias',
      legalBasis:
        'Consentimiento (Art. 6.1.a RGPD) - Consentimiento específico e informado',
      dataTransfer:
        'Múltiples países (EE.UU., Reino Unido) bajo adequacy decisions y BCR',
    ...
    },
    {
      ...
      description:
        'Cookies que mejoran la funcionalidad del sitio web recordando preferencias y configuraciones del usuario.',
      essential: false,
      enabled: false,
      purpose:
        'Personalización de experiencia, recordatorio de preferencias y configuraciones',
      legalBasis:
        'Consentimiento (Art. 6.1.a RGPD) - Consentimiento previo para funcionalidades mejoradas',
      dataTransfer: 'Principalmente procesamiento local (España/UE)',
      retention: '12 meses promedio',
      processors: [
        'Kopp Stadium S.L.',
        'Proveedores de chat (certificados UE)',
      ],
      cookies: [
        {
    ...
    },
    {
      ...
      description:
        'Cookies que permiten personalizar contenido y ofertas basándose en el comportamiento e intereses del usuario.',
      essential: false,
      enabled: false,
      purpose:
        'Personalización de contenido, recomendaciones y experiencia usuario',
      legalBasis:
        'Consentimiento (Art. 6.1.a RGPD) - Consentimiento específico para personalización',
      dataTransfer: 'Procesamiento mixto (UE/terceros países con adequacy)',
      retention: '6-24 meses según finalidad',
      processors: [
        'Kopp Stadium S.L.',
        'Proveedores de personalización certificados',
      ],
      cookies: [
        {
          name: 'user_segments',
  ...
  static getCookiesPolicy(): {
    ...
    return {
      ...
      legalFramework: {
        ...
        directiveCookies:
          'Directiva 2009/136/CE sobre privacidad y comunicaciones electrónicas',
  ...
  static validateConsent(consent: CookieConsent): boolean {
    ...
    return requiredFields.every(
      (field) => consent[field as keyof CookieConsent] !== undefined
    );
  }
  ...
  static isCookieAllowed(
    ...
    const cookie = this.COOKIE_CATEGORIES.flatMap(
  ...
  static getCookiesByCategory(categoryId: string): CookieDefinition[] {
    const category = this.COOKIE_CATEGORIES.find(
  ...
  static generateComplianceReport(): any {
    return {
      ...
      totalCookies: this.COOKIE_CATEGORIES.reduce(
        (sum, cat) => sum + cat.cookies.length,
        0
      ),
      essentialCookies: this.COOKIE_CATEGORIES.filter((cat) => cat.essential)
        .length,
      dataTransfers: this.COOKIE_CATEGORIES.flatMap(
        (cat) => cat.processors
